...
/// nothing of Alloy's and its closing method is not called `dispose`. Every
/// `Bloc`, `Cubit`, `ChangeNotifier` and `StreamController` is this shape.
void closeSessionCache(SessionCache cache) => cache.close();

/// A class Alloy has no way to recognise as closeable.
///
...
@AlloyInject(dispose: closeSessionCache)
class SessionCache {
  SessionCache();
