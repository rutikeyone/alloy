...
class AlloyInspectorTheme extends InheritedWidget {
  /// Dresses [child] and everything under it in [data].
  const AlloyInspectorTheme({
    required this.data,
  ...
  final AlloyInspectorThemeData data;
  ...
  static AlloyInspectorThemeData of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<AlloyInspectorTheme>()?.data ??
      AlloyInspectorThemeData.of(Theme.of(context));

  @override
  bool updateShouldNotify(AlloyInspectorTheme oldWidget) =>
      data != oldWidget.data;
}
