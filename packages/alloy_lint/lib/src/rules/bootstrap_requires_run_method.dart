...
/// Reports an `@AlloyBootstrap` class with no `run()` method, which cannot
/// satisfy `AlloyBootstrapStep`.
class BootstrapRequiresRunMethod extends AnalysisRule {
  ...
  static const code = LintCode(
    'alloy_bootstrap_requires_run_method',
    "'{0}' is annotated with @AlloyBootstrap but declares no 'run()' method.",
    correctionMessage:
        'Implement AlloyBootstrapStep, which requires a name getter and a '
        'run() method.',
  );
