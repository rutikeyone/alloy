...
class CobaltInspectorThemeData {
  ...
  Color colorOfLevel(CobaltLogLevel level) => switch (level) {
    CobaltLogLevel.error => failure,
    CobaltLogLevel.warning => startup,
    CobaltLogLevel.info ||
  ...
  Color colorOfLifetime(CobaltRegistrationKind kind) => switch (kind) {
  ...
  IconData iconOfFamily(CobaltInspectorFamily family) => switch (family) {
