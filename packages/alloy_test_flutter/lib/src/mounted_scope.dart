...
/// because `AlloyScopeProvider.of` searches *above* the element it is given
...
AlloyScope mountedRootScope(WidgetTester tester) => tester
    .widgetList<AlloyScopeProvider>(find.byType(AlloyScopeProvider))
    .last
    .scope
    .root;
