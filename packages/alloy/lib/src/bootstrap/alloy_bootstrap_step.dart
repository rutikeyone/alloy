...
/// arguments.
///
/// Classes annotated `@AlloyBootstrap` are collected into `$alloyBootstrap`
/// automatically; implementing this interface and passing the list by hand is
/// the Manual Mode equivalent.
abstract interface class AlloyBootstrapStep {
  /// Identifies the step in diagnostics and in `AlloyBootstrapError`.
  String get name;
