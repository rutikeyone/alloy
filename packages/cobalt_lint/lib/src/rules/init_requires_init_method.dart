...
/// Reports an `@CobaltInit` class with no `init()` method.
///
...
class InitRequiresInitMethod extends AnalysisRule {
  ...
  static const code = LintCode(
    'cobalt_init_requires_init_method',
    "'{0}' is annotated with @CobaltInit but declares no 'init()' method.",
    correctionMessage:
        "Implement AsyncInitializable and add 'Future<void> init()', or drop "
        'the @CobaltInit annotation.',
  );
