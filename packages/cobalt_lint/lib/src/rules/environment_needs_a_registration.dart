...
/// Reports `@CobaltEnvironment` on a class that nothing registers.
///
...
class EnvironmentNeedsARegistration extends AnalysisRule {
  ...
  static const code = LintCode(
    'cobalt_environment_needs_a_registration',
    "'{0}' names an environment but is never registered.",
    correctionMessage:
        '@CobaltEnvironment restricts a registration to some environments. Add '
        '@CobaltInject, @CobaltInit or @CobaltBootstrap, or remove the '
        'environment.',
  );
