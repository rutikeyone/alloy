...
const _injectMatcher = CobaltAnnotationMatcher('CobaltInject');

/// Reports an `@CobaltInject` class the container cannot build — abstract, or
...
class InjectableMustBeConstructible extends AnalysisRule {
  ...
  static const code = LintCode(
    ...
    "Cobalt cannot construct '{0}': {1}.",
    correctionMessage:
        'Give the class a public generative constructor, or register it '
        'manually and drop the @CobaltInject annotation.',
  );
