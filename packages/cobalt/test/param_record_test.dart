...
final class EditorFactory implements CobaltParamFactory<Editor, EditorArgs> {
  const EditorFactory();

  @override
  Editor create(CobaltResolver resolver, EditorArgs args) => Editor(
    resolver.get<Repo>(),
    id: args.id,
    title: args.title,
    draft: args.draft,
...
final class TicketFactory implements CobaltParamFactory<Ticket, (int, String)> {
  const TicketFactory();

  @override
  Ticket create(CobaltResolver resolver, (int, String) args) =>
