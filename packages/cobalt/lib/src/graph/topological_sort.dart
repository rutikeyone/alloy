...
typedef CobaltDependenciesOf<T> = Iterable<T> Function(T node);
...
/// supplied elsewhere. A cycle throws `CobaltCycleError` naming the path, found
/// by walking the nodes that never drained.
List<List<T>> layeredTopologicalSort<T extends Object>(
  Iterable<T> nodes,
  CobaltDependenciesOf<T> dependenciesOf, {
