...
Shared static analysis layer for [Alloy](https://github.com/rutikeyone/alloy). It turns annotated
Dart source into a typed intermediate representation.

Both `alloy_generator` and `alloy_lint` consume this package, so a declaration is parsed by one
