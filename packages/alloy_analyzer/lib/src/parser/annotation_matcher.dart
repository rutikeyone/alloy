...
const alloyAnnotationsPackage = 'alloy_annotations';
...
/// declaration between files inside `alloy_annotations` does not break the
/// generator, and test stubs of the annotations still resolve.
class AlloyAnnotationMatcher {
  const AlloyAnnotationMatcher(
    this.typeName, {
    this.package = alloyAnnotationsPackage,
  });
