class AlloyTypeRef {
  ...
  factory AlloyTypeRef.fromJson(Map<String, dynamic> json) => AlloyTypeRef(
    name: json['name'] as String,
    import: json['import'] as String?,
    typeArguments: [
      for (final arg in json['typeArguments'] as List<dynamic>)
        AlloyTypeRef.fromJson(arg as Map<String, dynamic>),
    ],
  ...
  bool operator ==(Object other) =>
      other is AlloyTypeRef && other.signature == signature;
